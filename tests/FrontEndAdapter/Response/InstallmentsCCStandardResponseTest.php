 ...
 * @covers \AmazonPaymentServicesSdk\FrontEndAdapter\Response\InstallmentsCCStandardResponse
 ...
 */
class InstallmentsCCStandardResponseTest extends APSTestCase
{
    private InstallmentsCCStandardResponse $installmentsCCStandardResponse;
    ...
    public function setUp(): void
    {
        ...
        try {
            ...
            $this->installmentsCCStandardResponse = new InstallmentsCCStandardResponse($fakeResponseData);
    ...
    /**
     * @test
     * @covers \AmazonPaymentServicesSdk\FrontEndAdapter\Response\InstallmentsCCStandardResponse::getSuccessStatusCodes
     *
     * @return void
     */
    public function testGetSuccessStatusCodes(): void
    {
        $statusCodes = $this->installmentsCCStandardResponse->getSuccessStatusCodes();
    ...
    /**
     * @test
     * @covers \AmazonPaymentServicesSdk\FrontEndAdapter\Response\InstallmentsCCStandardResponse::getPaymentOptions
     *
     * @return void
     */
    public function testGetPaymentOptions(): void
    {
        $paymentOptions = $this->installmentsCCStandardResponse->getPaymentOptions();
    ...
    /**
     * @test
     * @covers \AmazonPaymentServicesSdk\FrontEndAdapter\Response\InstallmentsCCStandardResponse::process
     *
     * @return void
     */
    public function testProcess_noSuccess(): void
    {
        try {
            ...
            $this->assertNull($this->installmentsCCStandardResponse->process());
        } catch (APSException $e) {
            $this->fail($e->getMessage());
        }
    }
    ...
    public function testProcess_authorizationProcessAgain(): void
    {
        try {
            ...
            $this->installmentsCCStandardResponse = new InstallmentsCCStandardResponse($fakeResponseData, $returnData);
            ...
            $doReplaceApsConnector = $replaceApsConnector->bindTo($this->installmentsCCStandardResponse, InstallmentsCCStandardResponse::class);
